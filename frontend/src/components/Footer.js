...
function Footer() {
  return (
    <footer className="text-white" style={{background: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)'}}>
      <div className="container mx-auto px-6 py-12 lg:px-10">
        <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2 text-sm text-slate-200">
              <li>
                <a className="hover:text-white" href="#features">Fitur</a>
              </li>
              <li>
                <a className="hover:text-white" href="#pricing">Harga</a>
              </li>
              <li>
                <a className="hover:text-white" href="#testimonials">Testimoni</a>
              </li>
              <li>
                <a className="hover:text-white" href="#examples">Contoh</a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2 text-sm text-slate-200">
              <li>
                <a className="hover:text-white" href="/tentang">Tentang Kami</a>
              </li>
              <li>
                <a className="hover:text-white" href="#">Kontak</a>
              </li>
              <li>
                <a className="hover:text-white" href="#">Karir</a>
              </li>
            </ul>
          </div>
        ...
        <div className="mt-12 border-t border-slate-500 pt-8 text-center text-sm text-slate-300 md:flex md:justify-between">
          <p>© 2025 CartaAI. All rights reserved.</p>
