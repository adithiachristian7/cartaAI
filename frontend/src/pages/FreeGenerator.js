...
function FreeGenerator() {
  ...
  const handleGenerate = async (e) => {
    ...
    try {
      // Free tier doesn't upload assets
      const dataForDb = { ...formData };
        ...
        content: `
          <div style="font-family: sans-serif; min-width: 200px;">
            ...
            <div style="display: flex; flex-direction: column; gap: 8px;">
              <a href="${finalUrl}" target="_blank" rel="noopener noreferrer" style="text-decoration: none; background: #4b5563; color: white; padding: 10px; border-radius: 10px; font-weight: 700; font-size: 11px; text-align: center; display: block;">
                👁️ Lihat Pratinjau
              </a>
        ...
        <div className="py-16 px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <div className="inline-flex items-center gap-2 bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 px-4 py-2 rounded-full text-sm font-bold mb-4">
              ...
              <h1 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">
                ...
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-gray-500 to-gray-700 dark:from-gray-300 dark:to-gray-500">
                  Gratis
                </span>
              </h1>
              <div className="relative inline-block mb-6">
                <div className="w-28 h-1 bg-gradient-to-r from-gray-400 to-gray-600 rounded-full mx-auto"></div>
                <div className="absolute -top-1.5 left-1/2 transform -translate-x-1/2 w-5 h-5 bg-white dark:bg-gray-800 rounded-full border-4 border-gray-400 shadow-md"></div>
              </div>
              <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                Buat undangan pernikahan sederhana dengan fitur gratis.
                Lengkapi form di bawah ini dan biarkan AI membuat undangan Anda.
                Untuk kustomisasi lebih lanjut, silakan upgrade ke Premium.
              </p>
            </div>
              ...
              <div className="group relative overflow-hidden rounded-2xl bg-white dark:bg-gray-800 shadow-lg border border-gray-100 dark:border-gray-700 transition-all duration-300 hover:shadow-xl">
                ...
                <form onSubmit={handleGenerate} className="p-8">
                    ...
                    <div className="space-y-6">
                      ...
                      <div>
                        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2 flex items-center gap-1">
                          Tema Warna <span title="Fitur ini terkunci di versi Gratis" className="material-symbols-outlined text-yellow-500 text-sm cursor-help">lock</span>
                        </label>
                        <select
                          name="temaWarna"
                          value=""
                          disabled
                          className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 bg-gray-100 dark:bg-gray-700 text-gray-500 dark:text-gray-400 rounded-xl outline-none cursor-not-allowed"
                        >
                          <option value="">Terkunci (Premium)</option>
                        </select>
                      </div>
                      ...
                      <div>
                        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2 flex items-center gap-1">
                          Jenis Undangan <span title="Fitur ini terkunci di versi Gratis" className="material-symbols-outlined text-yellow-500 text-sm cursor-help">lock</span>
                        </label>
                        <select
                          name="jenisUndangan"
                          value=""
                      ...
                      <div>
                        <label className="block text-sm font-medium text-gray-700 dark:text-white mb-2 flex items-center gap-1">
                          Musik Latar <span title="Fitur ini terkunci di versi Gratis" className="material-symbols-outlined text-yellow-500 text-sm cursor-help">lock</span>
                        </label>
                        <input
                          type="file"
                          disabled
                          className="w-full file:mr-4 file:py-2 file:px-4 file:rounded-xl file:border-0 file:text-sm file:font-semibold file:bg-gray-300 file:text-gray-500 bg-gray-100 dark:bg-gray-800 text-gray-400 cursor-not-allowed"
                        />
                      </div>
                      {/* ... input file lainnya ... */}
                      <div>
                        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2 flex items-center gap-1">
                          Foto Mempelai Pria <span title="Fitur ini terkunci di versi Gratis" className="material-symbols-outlined text-yellow-500 text-sm cursor-help">lock</span>
                        </label>
                        <input
                          type="file"
                          disabled
                      ...
                      <div>
                        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2 flex items-center gap-1">
                          Foto Mempelai Wanita <span title="Fitur ini terkunci di versi Gratis" className="material-symbols-outlined text-yellow-500 text-sm cursor-help">lock</span>
                        </label>
                        <input
                          type="file"
                          disabled
                      ...
                      <div>
                        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2 flex items-center gap-1">
                          Galeri Foto Pre-Wedding <span title="Fitur ini terkunci di versi Gratis" className="material-symbols-outlined text-yellow-500 text-sm cursor-help">lock</span>
                        </label>
                        <input
                          type="file"
                          disabled
                  ...
                  <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center relative z-10">
                    ...
                    <Link
                      to="/harga"
                      className="bg-gradient-to-r from-yellow-400 to-orange-500 hover:from-yellow-500 hover:to-orange-600 text-white px-8 py-4 rounded-xl font-semibold text-lg shadow-lg transition-all duration-300 text-center flex items-center justify-center translate-y-0 hover:-translate-y-1 hover:shadow-xl"
                    >
                      <span className="material-symbols-outlined mr-2">
                        diamond
                      </span>
