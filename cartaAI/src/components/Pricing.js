        ...
        <div className="mt-16 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-2">
          {pricingPlans.map((plan, index) => (
            ...
            >
              ...
              {/* Tombol utama (sudah ada dari awal) */}
              <Link
                to={plan.buttonLink}
              ...
              {/* Tambahan tombol Bayar khusus Premium */}
              {plan.name === 'Premium' && (
                <Link
                  to="/payment"
                  className="mt-4 w-full rounded-lg py-3 text-center font-bold bg-blue-500 text-white hover:bg-blue-600 transition-all duration-300"
                >
                  Bayar
                </Link>
              )}
